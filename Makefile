...
BUILD		:=	build
SOURCES		:=	source source/game/states source/game/classes source/modules source/objects source/libs/tremor
DATA		:=	data
INCLUDES	:=	include source source/libs/tremor

APP_TITLE	:=	TurtleShell
APP_AUTHOR	:=	TurtleP
APP_DESCRIPTION	:=	Implementation of a custom Home Menu
...
APP_PRODUCT_CODE := CTR-P-TS
APP_UNIQUE_ID := 0x40D3
...
LIBS	:= -lsfil -lsf2d -lsftd -lfreetype -lpng -ljpeg -lz  -lctru -lm -logg -lcitro3d
